...
class WebUiTests(AppTestCase):
    ...
    def test_sync_controls_render_in_separate_view_and_sync_columns(self) -> None:
        ...
        self.assertIn("export function compatibilityInSessionSeekDecision", video_core_js)
        self.assertIn("export function shouldApplyDeferredCompatibilitySeek", video_core_js)
        self.assertIn("export function compatibilityEncodedMediaEndSeconds", video_core_js)
        self.assertIn("export const HLS_SEGMENT_DURATION_SECONDS", video_core_js)
        self.assertIn("compatibilityInSessionSeekDecision", video_js)
        self.assertIn("function trySeekCompatibilityInSession", video_js)
        self.assertIn("in_session_seek_requested", video_js)
        ...
        self.assertIn("'/video/endpoints/subtitles/all?path='", video_js)
        self.assertIn("function subtitleTrackUrl(item, subtitleStreamIndex)", video_js)
        self.assertIn("function allSubtitlesUrl(item)", video_js)
        self.assertIn("function resyncSubtitleTrackAfterHlsRecovery(reason, data)", video_js)
        self.assertIn("function subtitlesAreMounted(item, streamIndex, seekSeconds)", video_js)
        self.assertIn("function hlsErrorTargetsCurrentSession(data)", video_js)
        ...
        self.assertIn("function subtitleStreamRequiresBurnIn(stream)", video_js)
        self.assertIn("Burn-in restart", video_js)
        ...
        self.assertIn("function mountSubtitleTrackForItem(item, probePayload, streamIndex, seekSeconds, options)", video_js)
        self.assertIn("Subtitle track mounted", video_js)
        self.assertIn("subtitleMountedSeekSeconds", video_js)
        self.assertIn("subtitleMountedStreamIndex", video_js)
        self.assertIn("Subtitle resync skipped for stale HLS session", video_js)
        self.assertIn("already-mounted", video_js)
        self.assertIn("function resolvedSubtitleStreamIndex(item, probePayload)", video_js)
        self.assertIn("function ensureSubtitlesAfterPlaybackReady(reason)", video_js)
        self.assertIn("function applySubtitlesForSeek(item, probePayload, seekSeconds, options)", video_js)
        self.assertIn("function reportSubtitleSyncDiagnostic(fields)", video_js)
        self.assertIn("Subtitle mount started", video_js)
        self.assertIn("function resetPlaybackSurface()", video_js)
        self.assertIn("function resetSubtitlesForActiveItemChange(item)", video_js)
        self.assertIn("Subtitles cleared for playback item change", video_js)
        self.assertIn("clearSubtitleTrack();", video_js)
        self.assertIn("playbackSyncToken: ctx.state.playbackSyncToken", video_js)
        self.assertIn("Subtitle track will load when playback seek completes.", video_js)
        ...
        self.assertIn("subtitle_stream_index", video_js)
        ...
        self.assertIn("Restarting compatibility playback for burned-in subtitles.", video_js)
        ...
        self.assertIn("function parseWebVttCues(vttText)", video_js)
        self.assertIn("function syncSubtitleDebugDisplay()", video_js)
        self.assertIn("function findNextParsedCue(cues, mediaTime)", video_js)
        self.assertIn("function formatAbsoluteCueRange(startSeconds, endSeconds)", video_js)
        self.assertIn("debugCurrentCueEl", video_js)
        self.assertIn("debugNextCueEl", video_js)
        self.assertIn("video-subtitles", video_js)
        self.assertIn("Subtitle cue display changed", video_js)
        ...
        self.assertIn("VIDEO_ICONS", video_js)
        self.assertIn("formatNativePlaybackTime", video_js)
        self.assertIn("revealControlsOverlay", video_js)
        self.assertIn("setControlButtonState", video_js)
