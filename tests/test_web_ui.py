...
class WebUiTests(AppTestCase):
    ...
    def test_sync_controls_render_in_separate_view_and_sync_columns(self) -> None:
        ...
        self.assertIn('controls preload="metadata"', html)
        ...
        self.assertIn("export function nativePlaybackUrl", video_core_js)
        self.assertIn("export function playbackDecisionForItem", video_core_js)
        ...
        self.assertIn("Selected audio track will apply to compatibility playback when needed.", video_js)
        ...
        self.assertIn("playbackDecisionForItem", video_js)
        ...
        self.assertIn("Compatibility playback is required for this format, but ffmpeg is unavailable.", video_js)
        self.assertIn("Playing through the existing remote file stream.", video_js)
