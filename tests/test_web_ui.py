...
class WebUiTests(AppTestCase):
    ...
    def test_sync_controls_render_in_separate_view_and_sync_columns(self) -> None:
        ...
        self.assertIn('id="music-pause" aria-label="Pause" title="Pause" class="hidden" hidden', html)
        ...
        self.assertIn('src="/assets/icons/material-icon-theme/music-pause.svg"', html)
        ...
        self.assertIn("startMetadataLoad(song);", js)
