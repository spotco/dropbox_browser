...
class WebUiTests(AppTestCase):
    ...
    def test_sync_controls_render_in_separate_view_and_sync_columns(self) -> None:
        ...
        self.assertIn("function clearLegacyFullWindowSetting", js)
        self.assertIn("localStorage.removeItem('dropbox-browser.bottom-panel-full-window')", js)
        ...
        self.assertNotIn("Settings.get(fullWindowSettingKey, false)", js)
        self.assertNotIn("Settings.set(fullWindowSettingKey, true)", js)
        self.assertNotIn("Settings.set(fullWindowSettingKey, false)", js)
