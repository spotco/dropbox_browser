...
class WebUiTests(AppTestCase):
    ...
    def test_sync_controls_render_in_separate_view_and_sync_columns(self) -> None:
        ...
        with TestServer(app) as server:
            ...
            photo_map_css = server.get_text("/assets/css/photo-map.css")
            ...
            photo_map_js = server.get_text("/assets/js/photo-map.js")
            photo_map_config_js = server.get_text("/assets/js/photo-map/config.js")
            photo_map_cache_js = server.get_text("/assets/js/photo-map/cache.js")
            photo_map_parsers_js = server.get_text("/assets/js/photo-map/parsers.js")
            photo_map_queue_js = server.get_text("/assets/js/photo-map/queue.js")
            photo_map_thumbnails_js = server.get_text("/assets/js/photo-map/thumbnails.js")
            photo_map_leaflet_js = server.get_text("/assets/js/photo-map/leaflet.js")
            photo_map_map_js = server.get_text("/assets/js/photo-map/map.js")
            photo_map_diagnostics_js = server.get_text("/assets/js/photo-map/diagnostics.js")
            ...
            music_waveform_controller_js = server.get_text("/assets/js/music/waveform/controller.js")
            music_waveform_worker_js = server.get_text("/assets/js/music/waveform/worker.js")
            js = "\n".join([
        ...
        self.assertIn("bottom-panel-bootstrapping", html)
        self.assertIn('data-bottom-panel-ready="0"', html)
        self.assertIn("body.bottom-panel-bootstrapping #log-panel", css)
        self.assertIn("pointer-events: none;", css)
        self.assertIn("markBottomPanelMediaLayoutReady", js)
        self.assertIn("getElementById('music-player-status-text')", js)
        self.assertIn("Loading(", js)
        self.assertIn("Loaded (", js)
        self.assertIn("LOAD_STATUS_TICK_MS = 100", js)
        self.assertIn("body.bottom-panel-full-window-mode", css)
        self.assertIn("body.bottom-panel-full-window-mode > header", css)
        self.assertIn("body.bottom-panel-full-window-mode > main", css)
        self.assertIn("body.bottom-panel-full-window-mode #log-panel", css)
        self.assertIn("body.bottom-panel-full-window-mode #log-resizer", css)
        self.assertIn("body.bottom-panel-full-window-mode .browse-horizontal-scrollbar", css)
        self.assertIn('id="bottom-pane-toolbar-actions"', html)
        ...
        self.assertIn('<link rel="stylesheet" href="/assets/css/photo-map.css">', html)
        ...
        self.assertIn('<script type="module" src="/assets/js/photo-map.js"></script>', html)
        ...
        self.assertIn("buildPhotoMapListingEndpoint", photo_map_js)
        self.assertIn("selectPhotoMapCandidates", photo_map_js)
        self.assertIn("PHOTO_MAP_JPEG_HEAD_RANGE_BYTES", photo_map_config_js)
        self.assertIn("PHOTO_MAP_METADATA_CONCURRENCY", photo_map_config_js)
        self.assertIn("PHOTO_MAP_CACHE_BATCH_LIMIT", photo_map_config_js)
        self.assertIn("createPhotoMapDiagnostics", photo_map_diagnostics_js)
        self.assertIn("classifyPhotoMapCandidate", photo_map_config_js)
        self.assertIn("readPhotoMapCache", photo_map_cache_js)
        self.assertIn("writePhotoMapCache", photo_map_cache_js)
        self.assertIn("photoMapCacheRecordForResult", photo_map_cache_js)
        self.assertIn("runPhotoMapMetadataQueue", photo_map_queue_js)
        self.assertIn("selectPhotoMapThumbnailItems", photo_map_thumbnails_js)
        self.assertIn("runPhotoMapThumbnailQueue", photo_map_thumbnails_js)
        self.assertIn("ensurePhotoMapLeaflet", photo_map_leaflet_js)
        self.assertIn("createPhotoMap", photo_map_map_js)
        self.assertIn("tile.openstreetmap.org", photo_map_map_js)
        self.assertIn("parseJpegExifGps", photo_map_parsers_js)
        self.assertIn("parseQuickTimeLocation", photo_map_parsers_js)
        self.assertIn("readPhotoMapRange", photo_map_parsers_js)
        self.assertIn("readPhotoMapItemMetadata", photo_map_parsers_js)
        self.assertIn("readPhotoMapItemMetadata", photo_map_js)
        self.assertIn("getMetadataResults", photo_map_js)
        self.assertIn("requestThumbnails", photo_map_js)
        self.assertIn("bottom-panel-full-window-changed", photo_map_js)
        self.assertIn("ResizeObserver", photo_map_js)
        self.assertIn("Settings.get('bottom-pane-mode', 'server-log')", photo_map_js)
        self.assertIn("bottom-pane-mode-changed", photo_map_js)
        self.assertIn("browse-folder-changed", photo_map_js)
        self.assertNotIn("recursive", photo_map_js.lower())
        ...
        self.assertIn("var preferredHeight = defaultHeight", js)
        self.assertIn("var fullWindowSettingKey = 'bottom-panel-full-window'", js)
        self.assertIn("function shouldPersistFullWindowState", js)
        ...
        self.assertIn("fullWindowButton.disabled = fullWindowActive", js)
        self.assertIn("fullWindowButton.setAttribute('aria-pressed', 'false')", js)
        ...
        self.assertNotIn("source: 'drag'", js)
        ...
        self.assertIn('data-music-waveform-cache-entry-limit="20"', html)
        ...
        self.assertIn('id="music-playlist-recent"', html)
        self.assertIn('id="music-playlist-recent-dialog"', html)
        self.assertIn('data-recent-sort-key="played_at"', html)
        self.assertIn('data-recent-sort-key="filename"', html)
        self.assertIn('data-recent-sort-key="playlist_name"', html)
        ...
        self.assertIn('id="music-waveform-reload"', html)
        self.assertIn('id="music-waveform-live-status"', html)
        ...
        self.assertIn('<span>Index</span>', html)
        self.assertIn('<span>Absolute Path</span>', html)
        self.assertIn('class="music-playlist-column-resizer" data-music-playlist-column-resizer="index"', html)
        ...
        self.assertIn("flex: 0 0 auto", music_css)
        self.assertIn("#photo-map-pane", photo_map_css)
        self.assertIn(".photo-map-shell", photo_map_css)
        self.assertIn(".photo-map-map", photo_map_css)
        self.assertIn("flex: 1 1 auto", photo_map_css)
        ...
        self.assertIn(".music-waveform-panel", music_css)
        self.assertIn(".music-waveform-canvas", music_css)
        self.assertIn(".music-waveform-status-row", music_css)
        self.assertIn(".music-waveform-reload", music_css)
        self.assertIn(".music-waveform-live-status", music_css)
        ...
        self.assertIn("--music-playlist-grid-columns: 52px minmax(120px, 0.9fr) minmax(150px, 1.1fr) 56px;", media_library_css)
        self.assertIn(".music-playlist-index-cell", media_library_css)
        self.assertIn(".music-playlist-entry.current .music-playlist-filename-cell::before", media_library_css)
        self.assertIn("pane.setAttribute('data-player-ready', 'library')", music_entry_js)
        self.assertIn("initWaveformController", music_entry_js)
        self.assertIn("waveformDetails: document.getElementById('music-waveform-panel')", music_entry_js)
        self.assertIn("music-waveform-open", music_waveform_controller_js)
        self.assertIn("waveformReloadButton: document.getElementById('music-waveform-reload')", music_entry_js)
        self.assertIn("ctx.waveformApi = initWaveformController(ctx);", music_entry_js)
        self.assertIn("sameWaveformIdentity", music_waveform_controller_js)
        self.assertIn("new Worker('/assets/js/music/waveform/worker.js', {type: 'module'})", music_waveform_controller_js)
        self.assertIn("computeCombinedWaveformSummary", music_waveform_worker_js)
        self.assertIn("mergeWaveformSummary", music_waveform_worker_js)
        self.assertIn("WAVEFORM_WORKER_SLICE_BUDGET_MS", music_waveform_worker_js)
        self.assertIn("ctx.waveformApi.setActiveSong(song)", music_playback_js)
        self.assertIn("ctx.waveformApi.setActiveSong(null)", music_playback_js)
        ...
        self.assertIn("function restoreMusicPanePercents()", music_layout_js)
        self.assertIn("function scheduleMusicPaneRestore()", music_layout_js)
        ...
        self.assertIn("import {formatPlaybackTime, setPlaylistPlaybackStatus} from '../media-library/shared.js';", music_playback_js)
        self.assertIn("window.addEventListener('resize', function () {", music_entry_js)
        self.assertIn("ctx.layoutApi.restoreMusicPanePercents();", music_entry_js)
        self.assertIn("ctx.layoutApi.refreshPlaylistColumnWidths(false);", music_entry_js)
        self.assertIn("markBottomPanelMediaLayoutReady('music')", music_entry_js)
        self.assertIn("playlistColumnWidthSettingKey: 'music-playlist-column-widths'", music_entry_js)
        ...
        self.assertIn("function restoreRecentRecord(record)", music_playlist_js)
        self.assertIn("function recentSortLabel(sortKey)", music_playlist_js)
        self.assertIn("recordPlaybackStart", music_playback_js)
        self.assertIn("RecentStore", music_entry_js)
        self.assertIn("ctx.libraryApi.resetLibraryForCurrentFolder();", music_entry_js)
        self.assertIn('id="video-player-pane"', html)
        self.assertIn('id="photo-map-pane"', html)
        self.assertIn('id="photo-map-pane" class="bottom-pane-view hidden" data-pane-mode="photo-map" hidden', html)
        self.assertIn('role="toolbar" aria-label="Photo Map controls"', html)
        ...
        self.assertIn('id="video-playlist-recent"', html)
        self.assertIn('id="video-playlist-recent-dialog"', html)
        self.assertIn('data-recent-sort-key="played_at"', html)
        ...
        self.assertIn("WebVTT overlay only.", html)
        self.assertIn("bitmap (PGS) tracks keep the existing burned-in overlay, which ignores size and offset.", html)
        ...
        self.assertIn("musicPaneWidthSettingKey: 'video-media-library-pane-widths'", video_js)
        self.assertIn("function restoreVideoPaneLayout()", video_js)
        self.assertIn("ctx.layoutApi.restoreMusicPanePercents();", video_js)
        self.assertIn("ctx.layoutApi.refreshPlaylistColumnWidths(false);", video_js)
        self.assertIn("markBottomPanelMediaLayoutReady('video')", video_js)
        self.assertIn("playlistColumnWidthSettingKey: 'video-playlist-column-widths'", video_js)
        self.assertIn("ctx.layoutApi.applyMusicPanePercents(ctx.layoutApi.readSavedMusicPanePercents(), false);", video_js)
        self.assertIn("import {PlaylistStore} from './media-library/playlist-store.js';", video_js)
        self.assertIn("import {RecentStore} from './media-library/recent-store.js';", video_js)
        ...
        self.assertIn("recordPlaybackStart", video_media_library_bridge_js)
        ...
        self.assertNotIn("savedLogPanelHeight", video_js)
        ...
        self.assertIn("setPlaylistPlaybackStatus(ctx, ctx.activeQueueItem());", video_compatibility_js)
        ...
        self.assertIn("function exitExpandedLayoutWhenPlaybackIsUnavailable", video_playback_js)
        self.assertIn("void ctx.exitToEmbeddedPlaybackLayout();", video_playback_js)
        ...
        self.assertIn("ctx.els.playbackSurfaceEl.addEventListener('dblclick'", video_controls_js)
        self.assertIn("if (!videoControlsAvailable()) return;", video_controls_js)
        ...
        self.assertNotIn("savedLogPanelHeight", video_controls_js)
        self.assertIn("bottom-panel-full-window-changed", video_controls_js)
        self.assertNotIn("syncVideoFullWindowWithBottomPanel", video_controls_js)
        self.assertNotIn("setVideoFullWindowActive", video_controls_js)
        self.assertIn("event.key === 'Escape'", video_controls_js)
