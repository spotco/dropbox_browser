...
class WebUiTests(AppTestCase):
    ...
    def test_sync_controls_render_in_separate_view_and_sync_columns(self) -> None:
        ...
        self.assertIn("#music-player-pane .music-playlist-column-resizer", media_library_css)
        ...
        self.assertIn("#video-player-pane.video-full-window #video-queue-pane", video_css)
        ...
        self.assertIn("fetch('/video/endpoints/library?path='", video_library_js)
        self.assertIn("fetch('/video/endpoints/status')", video_library_js)
        self.assertIn("Current folder video library is ready to load.", video_library_js)
        ...
        self.assertIn("enqueueAndPlay", video_queue_js)
        self.assertIn("enqueueSelected", video_queue_js)
        self.assertIn("moveQueueIndex", video_queue_js)
