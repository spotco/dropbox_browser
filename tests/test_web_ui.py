...
class WebUiTests(AppTestCase):
    ...
    def test_sync_controls_render_in_separate_view_and_sync_columns(self) -> None:
        ...
        self.assertIn("defaultPollDelayMs: 4000", music_entry_js)
        ...
        self.assertIn("function libraryNameSortKey(name)", music_library_js)
        self.assertIn("function compareLibraryNames(left, right)", music_library_js)
        self.assertIn("map[key].sort(compareLibraryNames);", music_library_js)
        ...
        self.assertIn("els.treeEl.scrollTop = scrollTop", music_library_js)
        ...
        self.assertIn("state.playlistRemotePaths[song.remote_path]", music_playlist_js)
