...
class WebUiTests(AppTestCase):
    ...
    def test_sync_controls_render_in_separate_view_and_sync_columns(self) -> None:
        ...
        self.assertIn('/assets/icons/material-icon-theme/video-pip-enter.svg', html)
        ...
        self.assertIn("function togglePictureInPicture", video_controls_js)
        self.assertIn("requestFullscreen", video_controls_js)
        self.assertIn("requestPictureInPicture", video_controls_js)
