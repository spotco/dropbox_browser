...
class WebUiTests(AppTestCase):
    ...
    def test_sync_controls_render_in_separate_view_and_sync_columns(self) -> None:
        ...
        with TestServer(app) as server:
            ...
            video_library_js = server.get_text("/assets/js/video/library.js")
            video_queue_js = server.get_text("/assets/js/video/queue.js")
        ...
        self.assertIn("function setVideoFullWindowActive", js)
        self.assertIn("function applyFullWindowHeight", js)
        self.assertIn("if (videoFullWindowActive)", js)
        self.assertIn("applyFullWindowHeight();", js)
        self.assertIn("applyHeight(currentHeight);", js)
        self.assertIn("if (videoFullWindowActive) return;", js)
        ...
        self.assertIn("export function enqueueSelected", video_queue_core_js)
        self.assertIn("export function moveQueueIndex", video_queue_core_js)
        ...
        self.assertIn("Legacy flat video library UI — retired in Phase 5", video_library_js)
        self.assertIn("export function initLibrary", video_library_js)
        ...
        self.assertIn("Legacy video queue UI — retired in Phase 5", video_queue_js)
        self.assertIn("export function initQueue", video_queue_js)
