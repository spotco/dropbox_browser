export const VIDEO_ICONS = {
  ...
  fullWindowEnter: '/assets/icons/material-icon-theme/video-full-window-enter.svg',
  fullWindowExit: '/assets/icons/material-icon-theme/video-full-window-exit.svg',
