...
(function () {
  ...
  var ctx = {
    ...
    els: {
      ...
      subtitleBackgroundEl: document.getElementById('video-subtitle-background-enabled'),
    ...
    state: {
      ...
      narrowMusicPaneWidthSettingKey: 'video-narrow-pane-widths',
      narrowMusicPaneHeightSettingKey: 'video-narrow-pane-heights',
