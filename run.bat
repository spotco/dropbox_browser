...
start "Dropbox Browser Server" /b "%PYTHON_EXE%" -c "import sys; sys.path.insert(0, r'%APP_ROOT%'); from dropbox_browser.cli import main; raise SystemExit(main())" --remote dropbox:
